...
☑ **Tema Dinâmico (Dark/Light):** Alternância de temas perfeitamente integrada e controlada pelo usuário.
☑ **Filtro de Projetos:** Sistema dinâmico que permite filtrar os projetos exibidos por tecnologia (HTML, CSS, JS, etc).
...
- Paleta de Cores (Dark Mode):
  ...
  - Fundo Secundário: `#0F0F18`
  - Roxo Acento (Accent): `#7C3AED`
  - Roxo Claro: `#A78BFA`
- Paleta de Cores (Light Mode):
  - Fundo Primário: `#F4F4F8`
  - Fundo Secundário: `#EBEBF5`
  - Texto Primário: `#0F0F1A`
- Tipografia:
